...
class ModeloSupervisor{
	...
	static public function mdlMostrarSupervisor($tabla, $item, $valor){
	...
	static public function mdlEliminarSupervisor($tabla, $datos){
	...
	static public function mdlActualizarSupervisor($tabla, $item1, $valor1, $valor){
